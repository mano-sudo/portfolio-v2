...
export default function Hero() {
    ...
    return (
        <section className="w-full min-h-screen flex items-center justify-center relative py-20 overflow-hidden" style={{ isolation: 'isolate' }}>
            <div ref={heroRef} className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
                <div className="grid grid-cols-12 gap-6 items-center">
                    {/* Left Side Info */}
                    <div className="col-span-12 md:col-span-2 hero-side-info">
                    ...
                    <div className="col-span-12 md:col-span-8 text-center">
                        <div className="mb-6">
                            <p className="hero-name text-white/60 uppercase tracking-wider text-xs md:text-sm">Roman Caseres</p>
                        </div>
                    ...
                    {/* Right Side Info */}
                    <div className="col-span-12 md:col-span-2 hero-side-info-right text-right">
                        <div className="space-y-2 text-white uppercase tracking-wider text-xs md:text-sm">
